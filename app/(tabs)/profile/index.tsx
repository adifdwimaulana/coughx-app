...
export default function ProfileScreen() {
  ...
  const handleContact = () => {
    Alert.alert(
      ...
      [
        { text: 'Email', onPress: () => Linking.openURL('mailto:support@coughx.id') },
  ...
  const handleFeedback = () => {
    Alert.alert(
      ...
      [
        { 
          text: 'Kirim Email', 
          onPress: () => Linking.openURL('mailto:feedback@coughx.id?subject=Masukan untuk CoughX')
        },
        ...
        <View style={styles.infoSection}>
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoText}>
              CoughX adalah alat bantu skrining awal dan bukan pengganti diagnosis 
              medis profesional. Selalu konsultasi dengan dokter untuk pemeriksaan 
